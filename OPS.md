...
- e-TOLL етап 2: відповісти «так» на план варіанта 1 (сторінки кабінету IKK як людина); після переходу на облікові записи в картці компанії — видалити `/etc/transfin/etoll_ikk.env` і `/root/etoll_ikk_credentials.sh` (§2).
