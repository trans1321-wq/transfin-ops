...
- **На сервері:** код `8b4f0ed` (P1–P8, P5a, перенесення журналу, виправлення зависання й логіста, FINANCE читає Журнал; розгорнуто 21.09, §6). Сайт `active`, recorder `active`/`enabled` (з 20.09 не перезапускався, його код не змінювався). Ledger — `0006_audit_actor`. Нерозгорнутого немає.
...
- **Колега з роллю FINANCE** (personnel id 3, створена власником 21.09): доступ лише до **ТОВ «ВОТРАНС»**. Бачить «Фінанси» й **Журнал лише на перегляд**: рейси, чий тягач належить ВОТРАНС (на 21.09 — 3 з 6 рейсів ВОТРАНС; ще 3 без тягача їй не видно, доки тягач не вказано). Про водіїв бачить лише ім'я. Повні довідники й будь-які зміни Журналу — 403.
