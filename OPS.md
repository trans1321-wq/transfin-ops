...
- Паролі IKK e-TOLL: власник вирішив 22.09 **не змінювати** (працюємо з наявними). Ввести їх на сервер скриптом із прихованим вводом (етап 2 e-TOLL); після успішного пробного входу — видалити 5 старих файлів e-TOLL з iCloud (`etoll.py`, `etoll_debug.py`, `etoll_setup.py`, `etoll_cache.json`, `etoll_sessions/`).
